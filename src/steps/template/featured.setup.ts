...
export const FEATURED_META: TemplateMeta = {
  id: ARCHITECTURE_TYPE.FEATURED,
  repoUrl: "https://github.com/MGardier/create-nest-architect-template-featured.git",
};
...
/**
 * One method per unit of work, in the order of FEATURED_ACTIONS
 * (template.step.ts).
 */
export const FeaturedSetup = {
